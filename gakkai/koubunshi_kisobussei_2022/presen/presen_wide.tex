		...
		% \begin{block}{}
			\begin{columns}[T, onlytextwidth]
				...
				\column{.35\linewidth}
					...
					\vspace{2mm}
					\includegraphics[width=.8\textwidth]{hyst_break2.png}
                % \column{.1\linewidth}
			\end{columns}
		% \end{block}
\end{frame}
...
\begin{frame}
	\frametitle{各種の変形条件での力学的ヒステリシス}
		\centering
			\includegraphics[width=.8\textwidth]{hyst_shear_all.png}
...
\begin{frame}
	...
	\begin{exampleblock}{Andrews 理論}
		\begin{columns}[totalwidth=1\textwidth]
			...
			\column{.25\textwidth}
			\centering
			\includegraphics[width=.9\textwidth]{rubber_crack.png}
            \column{.25\textwidth}
			\centering
...
% 				\includegraphics[width=0.5\textwidth]{K4_d.png}
...
\begin{frame}
	\frametitle{ネットワーク構造でのG1-cord}
		\begin{center}
			\includegraphics[width=.6\textwidth]{g1cord.png}
		\end{center}
\end{frame}
