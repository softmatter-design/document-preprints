...
%
\renewcommand{\baselinestretch}{0.8} %全体の行間調整
...
% 	\centering
% 	\includegraphics[width=.4\textwidth]{Shear_Random_4chain_N20.png}
%     \vspace{2mm}
...
% \begin{wrapfigure}{r}[0pt]{0.4\textwidth}
% 	\centering
% 	\includegraphics[width=.4\textwidth]{CyclicDeform_4chain_rate_2e-4.png}
%     \vspace{2mm}
