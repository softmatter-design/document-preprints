...
\begin{frame}
    \frametitle{Reluxation of Initial Structure in KG Network}
		...
		\note{
			\begin{itemize}
				\item For KG model without mutual chain crossing, 
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			...
			\item functionality effect on modulus were examined and all fit to PNM.
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			\item to investigate for higher modulus,
			\item Employing Z1-code, number of entanglements per chain Z was calculated.
			\item the number is almost the same as homo-polymer melts.
			\item \textcolor{red}{(POINT left two)}
			\item 1.02 and 1.04
		\end{itemize}
	}
...
\begin{frame}
    \frametitle{Reduced Entanglements by NPT Model}
		...
		\note{
		\begin{itemize}
			\item Employing NPT relaxation, number of entanglements are reduced.
			\item calculated $<Z>_{Z1}$ = 0.36
			\item equilibrated modulus on stress relaxation is much reduced.
		\end{itemize}
	}
\end{frame}
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			\item Adapting Slip-tube model estimation, the measured modulus is fully explained.
			\item \textcolor{red}{(POINT left two)}
		\end{itemize}
	}
\end{frame}
