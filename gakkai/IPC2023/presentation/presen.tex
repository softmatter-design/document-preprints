    ...
    \frametitle{Adhesive Bonding Technology}
		...
		\note{
			...
			\begin{enumerate}
				...
				\begin{itemize}
					\item weight reduction of cars is big issue.
					\item for that purpose, multi-materialization 
					\item using Aluminum, Magnesium, CFR(T)Ps is discussed.
					\item these different colors
					\item in the process, adhesive bonding technology is a big key.
					\item for example, these red lines
				\end{itemize}
				...
				\begin{itemize}
					...
					\item ,  in which the polymer is repeatedly deformed at various deformation rates in order to ensure durability in long-term use.
				\end{itemize}
			\end{enumerate}
		}
\end{frame}
		...
		\note{
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item Positive correlation with fracture energy had been reported to have  by Payne.
				\end{itemize}
				\item The origin of hysteresis loss is also categorized by Payne
				\begin{itemize}
					\item Viscoelasticity based
					\item Crystallization 
					\item Derived by added filler
				\end{itemize}
			\end{itemize}
...
\begin{frame}
	...
	% \vspace{-2mm}
		...
		\note{
			\begin{itemize}
				\item On the fracture of rubber, Andrews proposed a model focused on Stress fields around the Crack top area
...
\begin{frame}
	\frametitle{Constraint Factors for Junction Points and Strands}
		...
		\begin{block}{Effect of other strands}
			...
			\note{
				\begin{itemize}
					\item VIcinity of Junction Point
					\begin{itemize}
