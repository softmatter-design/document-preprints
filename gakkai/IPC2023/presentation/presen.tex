			...
			\note{
				\begin{itemize}
					...
					\begin{itemize}
						...
						\item Considering topological effect can be counted as Ge
					\end{itemize}
				\end{itemize}
			}
		\end{block}
...
\begin{frame}
	...
	\vspace{-2mm}
		...
		\note{
			\begin{itemize}
				\item These three models are the recent approach for a evaluation of constraints.
...
\begin{frame}
	\frametitle{Random Networks as a key for PNM}
		...
		\note{
			\begin{itemize}
				\item Introduction of Random Connectivity is known to a key for PNM
				\item As a result, Criteria for PNM is fulfilled
				\item in these previous works, the network is not simple.
			\end{itemize}
		}
\end{frame}
