    ...
    \frametitle{Adhesive Bonding Technology}
		...
		\note{
			\begin{enumerate}
				...
				\begin{itemize}
					\item weight reduction of transportation equipment, especially automobiles is being considered.
		...
		\note{
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item and the intensity of  hysteresis loss had been reported to have Possitive correration with fracture energy by Payne.
				\end{itemize}
	...
	% \vspace{-2mm}
		...
		\note{
			\begin{itemize}
				...
				\item stress fields can be divide in twe regions, stress loading field and unloading one.
				\item On the progress of the crack, 
					\begin{itemize}
...
\begin{frame}
	\frametitle{Constraint Factors for Junction Points and Strands}
		...
		\end{alertblock}
		\vspace{-1mm}
		\begin{block}{Constraints Effect}
			\only<1>{
				\begin{itemize}
			...
			\begin{itemize}
				...
				\item ネットワーク構造の\alert{連結性にランダム性}を導入
                    \begin{itemize}
						...
						\begin{itemize}
							\item the mean values $\bar{\bm{r}}$ of starand fluctuate
							\item fluctuations $\Delta \bm{r} = \bm{r} - \bar{\bm{r}}$ are Gaussian
							\item the mean-square fluctuations depend only on structure
						\end{itemize}
					\end{itemize}
