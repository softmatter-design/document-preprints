		...
		\begin{block}{Effect of other strands (Combination of $G_c$ and $G_e$)}
			\only<1>{
				\begin{itemize}
					...
					\begin{itemize}
						\item Deviate from Phantom Network Model
						\item Affect $G_c$
					\end{itemize}
			...
			\note{
				\begin{itemize}
					...
					\begin{itemize}
						\item Junction points are surrounded by many of \alert{adjacent strands.}
						\item Because of other strands, Fluctuation of junctions are \alert{suppressed}. 
					\end{itemize}
					\item Effect is mainly two.
					\begin{itemize}
						\item One is Suppression of fluctuation of Junction Points
						\begin{itemize}
							\item this affect $G_c$, and Deviate from Phantom Network Model
						\end{itemize}
					...
					\begin{itemize}
						...
						\item Other is Considering topological effect, those were counted as Ge
					\end{itemize}
				\end{itemize}
			}
		\end{block}
	...
	\frametitle{Random Networks as a key for PNM}
		...
		\note{
			\begin{itemize}
				...
				\item the network is not so simple, and discussion is complicated.
			\end{itemize}
		}
\end{frame}
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			...
			\item e2e length of KG Chains is emulated in phantom chain.
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			...
			\item \textcolor{red}{(POINT)}
			\item Hysteresis loss was found for $\dot{\gamma} = 5e^{-5}$
