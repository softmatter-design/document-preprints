		...
		\note{
			...
			\begin{enumerate}
				...
				\begin{itemize}
					...
					\item these red lines are the adhesive bonded.
				\end{itemize}
	...
	\vspace{-1mm}
		...
		\note{
			\begin{itemize}
				\item hyst
				\begin{itemize}
					\item Mechanical Hysteresis is illustrated in this figure(POINT).
	...
	% \vspace{-2mm}
		...
		\note{
			\begin{itemize}
				...
				\item stress fields can be divide in twe regions, stress loading zone and unloading one.
				\item On the progress of the crack, 
					\begin{itemize}
		...
		\begin{block}{Effect of other strands (Combination of $G_c$ and $G_e$)}
			...
			\note{
				\begin{itemize}
					...
					\begin{itemize}
						\item One is Suppress the fluctuation of Junction Point
						\begin{itemize}
							\item Affect $G_c$, and Deviate from Phantom Network Model
						\end{itemize}
						\item Other is Strands Entangles each other
						\begin{itemize}
							\item Works as a Junction Point
							\item Generate additional $G_e$
						\end{itemize}
					\end{itemize}
					\item Concerning these effect, two approach was proposed
					\begin{itemize}
	...
	\vspace{-2mm}
		...
		\note{
			\begin{itemize}
				...
				\item The latest Rubinstein's Slip-tube model" seems proper(POINT).
	...
	\frametitle{Random Networks as a key for PNM}
		...
		\note{
			\begin{itemize}
				...
				\item the network is not so simple discussion is complicated.
			\end{itemize}
		}
\end{frame}
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			\item Keeping the density, Starand length were varied.
			\item Shorter chain length resulted in higher modulus.
			\item WIth proper chain length, N-48, PNM nature is found. 
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			\item WIth proper chain length, N-48, PNM nature is found. 
			\item functionality effect on modulus is perfect.
		\end{itemize}
	}
\end{frame}
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			\item The $\tan \delta$ of the glass transition decayed on a time scale of this region(POINT)
...
\begin{frame}
	...
	\note{
		\begin{itemize}
			\item Around this region(POINT), Hysteresis loss was found.
