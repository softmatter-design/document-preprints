	...
	% \vspace{-2mm}
		\begin{exampleblock}{Andrews Theory}
			...
			{E.H.Andrews, Y.Fukahori, J. of Mat. Sci. 12, 1307 (1977)}
						...
						\begin{itemize}
							\item \color{blue}{Stress Loading field} and \color{red}{Unloading one}
						\end{itemize}
					\item On the progress of the crack, \color{green}{stress field is transit}
						\begin{itemize}
							\item Hysteresis Loss$\Rightarrow${Energy Dissipation}
							\item \alert{Surpress} the progress of Crack
						\end{itemize}
				\end{itemize}
				\column{.25\linewidth}
					\begin{center}
