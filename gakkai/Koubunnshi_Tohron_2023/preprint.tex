...
省エネルギーの観点から自動車を中心とした輸送機器の大幅な軽量化の検討が進められており、その中でCFR(T)Pをはじめとする多様な新素材を用いたマルチマテリアル化の鍵のひとつとして接着接合技術が注目されている。
...
% Hysteresis is often attributed to filler origin or to meso-scale region behavior such as elongational crystallization~\cite{zhang}.
% Large hysteresis is also observed in sacrificial bonding in double network gels, known as ultra-high-strength gels~\cite{gong}.
