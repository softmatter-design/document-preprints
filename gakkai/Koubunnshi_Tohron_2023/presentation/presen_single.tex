...
\begin{frame}
	...
	\note{
		...
		\begin{itemize}
			\item Recent approach for rubber elasticity models are based on \alert{Phantom Network Model}.
			\item Introducing random connectivity, MD simulation studies were carried out.
			\item To investigate the criteria for Phantom Network Model, Two model chains are used.
			\begin{enumerate}
				\item Employing phantom chain, basics for PNM is examined.
				\item Changing the chain to \alert{KG Chain}, constraints effects are investigated.
				\begin{itemize}
					\item for KG Chain:
